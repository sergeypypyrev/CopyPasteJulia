...
# !!! Main.UserApp is configured as an alias for Main.Src and you might encounter it in some tests
using Main.Src, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "Src tests" begin
  @includetests ARGS
end
